...
private fun SettingsScreen(
    ...
    Column(
        ...
        SettingRow(
            title = if (lang == Lang.FA) "အမြန်ဆုံး ဆာဗာကို အလိုအလျောက် ရွေးချယ်ရန်" else "Auto-select fastest server",
            subtitle = if (lang == Lang.FA) "စက္ကန့် ၆၀ တိုင်း ဆာဗာအားလုံးကို စမ်းသပ်ပြီး အမြန်ဆုံး ဆာဗာကို အလိုအလျောက် ရွေးချယ်သည်" else "Pings all servers every 60s and switches to the lowest",
            checked = autoSelect,
...
MSNet သည် သင့်ကိုယ်ရေးကိုယ်တာ လုံခြုံရေးကို အလေးထား၍ ဖန်တီးထားသော VPN အက်ပ်ဖြစ်သည်။

ကျွန်ုပ်တို့ ဘာတွေစုဆောင်းသလဲ? — ဘာမှမစုဆောင်းပါ။
MSNet တွင် အကောင့်ဖွင့်ရန် မလိုအပ်ပါ။ အသုံးပြုမှု စာရင်းအင်းများ (Analytics)၊ ကြော်ငြာများ (Ads) နှင့် အသုံးပြုသူ ခြေရာခံခြင်း (Tracking) မရှိပါ။ သင်၏ အင်တာနက်အသုံးပြုမှု မှတ်တမ်းများကို လက်ခံသိမ်းဆည်းသော Server မည်သည့်အရာကိုမျှ Developer မှ မလည်ပတ်ပါ။

သင့်စက်အတွင်း သိမ်းဆည်းထားသော အချက်အလက်များ
သင်ထည့်သွင်းထားသော Server Config များကို App ၏ Private Storage တွင် လုံခြုံစွာ သိမ်းဆည်းထားပါသည်။ Data Usage (VPN Tunnel မှ ဖြတ်သန်းသော ဒေတာပမာဏ) ကို သင့်စက်အတွင်းတွင်သာ သိမ်းဆည်းထားပြီး မည်သည့် Server သို့မျှ ပို့ဆောင်ခြင်း မရှိပါ။ App Data ကို ဖျက်ပါက ယင်းအချက်အလက်များလည်း ဖျက်သွားပါမည်။

Network Requests
သင့် IP Address နှင့် ခန့်မှန်းတည်နေရာကို ပြသနိုင်ရန် MSNet သည် ipwho.is နှင့် ipify.org ကဲ့သို့သော Third-party Service များကို အသုံးပြုပါသည်။ ထို Service များသည် သင့် IP Address ကိုသာ မြင်နိုင်ပြီး အခြား ကိုယ်ရေးကိုယ်တာ အချက်အလက်များကို မပို့ဆောင်ပါ။

သင့် VPN Server များ
သင်ထည့်သွင်းသော Proxy / VPN Server များကို သင်ကိုယ်တိုင် သို့မဟုတ် သင်၏ Service Provider မှ စီမံပေးခြင်းဖြစ်သည်။ MSNet သည် ထို Server များ၏ Log Policy များကို ထိန်းချုပ်ခြင်း သို့မဟုတ် ကြည့်ရှုနိုင်ခြင်း မရှိပါ။ ယုံကြည်စိတ်ချရသော Provider ကိုသာ ရွေးချယ်အသုံးပြုပါ။

Permissions
VPN Permission ကို သင်ရွေးချယ်ထားသော Tunnel မှတစ်ဆင့် Internet Traffic ကို လမ်းကြောင်းပြောင်းရန်အတွက်သာ အသုံးပြုပါသည်။ သင့် Data များကို စစ်ဆေးခြင်း၊ ပြောင်းလဲခြင်း သို့မဟုတ် မှတ်တမ်းတင်ခြင်းအတွက် လုံးဝ အသုံးမပြုပါ။

ပြောင်းလဲမှုများ
App ဖွံ့ဖြိုးတိုးတက်လာသည်နှင့်အမျှ ဤ Privacy Policy ကို အချိန်နှင့်အမျှ ပြင်ဆင်နိုင်ပါသည်။ အရေးကြီးသော ပြောင်းလဲမှုများကို Version အသစ်များတွင် အသိပေးသွားပါမည်။

ဆက်သွယ်ရန်
မေးမြန်းလိုသည်များရှိပါက Telegram မှတစ်ဆင့် @andrew_ms_7 ကို ဆက်သွယ်နိုင်ပါသည်။
""".trimIndent()
